...
//            profileService.changePassword(currentUser.getUsername(), oldPassword, "secret777");
...
//
//        profileService.updateTraineeProfile(userService.findById(4L).get().getUsername(), "qwertyuiop", updatedTrainee.get());
