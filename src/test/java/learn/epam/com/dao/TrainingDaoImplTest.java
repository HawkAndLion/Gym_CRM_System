...
public class TrainingDaoImplTest {
    ...
    void shouldReturnTrainingWhenGetByIdCalled() {
        ...
        entityManager.flush();
        Trainee trainee = new Trainee(null, anotherUser.getId(), "Almaty", LocalDate.of(2000, 1, 1), true, new HashSet<>());
    ...
    void shouldReturnTrainingListWhenGetAllCalled() {
        ...
        entityManager.flush();
        Trainer trainer2 = new Trainer(null, user3.getId(), "Training Coach", true, new HashSet<>());
        entityManager.persist(trainer2);
        entityManager.flush();
        User user4 = new User(null, "Andy", "Right", "Andy.Right", "secret", true);
        entityManager.persist(user4);
        entityManager.flush();
        Trainee trainee2 = new Trainee(null, user4.getId(), "Wakanda", LocalDate.of(2000, 1, 1), true, new HashSet<>());
